...
public class GlobalExceptionHandler {
	...
	@Value("${app.debug:true}") // Set this in application.yml
...
//		errorBody.put("details", getStackTraceAsString(ex));
		}
	 ...
	 * @param ex pass exception
	 * @return String with the concatenate string 
	 */
