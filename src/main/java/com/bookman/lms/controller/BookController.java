 ...
 * delegates to the BookService for business logic.
 */
...
public class BookController {
	 ...
	 * @return ResponseEntity with the book and HTTP status 200 OK if found, or HTTP
	 ...
	 * @param book The Book object with updated information (sent in the request
	 *             body).
	...
	/**
	 * POST /api/books/batch Creates multiple books at the same time
	 * 
	 * @param books A list of Book objects to be created (sent in the request body
	 *              as a JSON array).
	 * @return ResponseEntity with the list of created books and HTTP status 201
	 *         CREATED.
	 */
	@PostMapping("/batch")
